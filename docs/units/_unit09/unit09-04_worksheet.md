...
*  Legen Sie für jede Rasterklasse (z.B. Wald Nicht-Wald) Werte fest, die die *Kosten* bzw den *Reibungswert* zur Überwindung/Nutzung der Zelle abbildet. Sinnvoll ist es also (im Sinne der Vorgaben) unattraktive Zellen mit hohen Werten und attraktive Zellen mit niedrigen Werten zu belegen. In diesem Fall sollen die Werte für die Hangneigung und für die Entfernung von der Straße nicht in Klassen eingeteilt werden sondern in Ihrer kontinuierlichen Ausprägung genutzt werden. 
